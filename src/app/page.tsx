...
export default function HomePage() {
  ...
  const content = {
    student: {
      ...
      subheadline:
        "AI-powered preparation for UK medical schools, universities, and competitive programmes",
      description:
        "Practice with realistic interview scenarios tailored to Oxbridge, Russell Group, and medical school formats. Get instant AI feedback on structure, reasoning, and communication.",
    ...
    university: {
      ...
      subheadline:
        "Enterprise-grade AI interview preparation for admissions offices and academic institutions",
      description:
        "Deploy structured interview practice across entire student cohorts with institutional analytics, GDPR compliance, and UK data residency. Built for Russell Group and medical schools.",
    ...
    nhs: {
      ...
      subheadline:
        "Band 5 to Consultant preparation aligned to NHS values and KSF dimensions",
      description:
        "Practice with scenarios built by NHS professionals. Cover compassion, clinical reasoning, and leadership competencies with instant structured feedback.",
      primaryCTA: "Try Free Demo",
  ...
  return (
    <>
      ...
      <section className="relative bg-gradient-to-b from-slate-50 to-white pt-20 pb-24 overflow-hidden">
        ...
        <div
          className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-purple-100 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse"
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="text-center animate-fade-up">
              ...
              <div className="flex sm:flex-row gap-4 justify-center mb-12">
                <MagneticButton
                  ...
                  strength={0.3}
                  onClick={
                    typeof current.primaryAction === "function"
                ...
                <Link
                  href={
                    typeof current.secondaryAction === "string"
              ...
              <p className="text-sm text-slate-500 mb-12 flex items-center justify-center gap-2">
                ...
                No subscription required • From £22 per mock • Instant AI
                feedback
              </p>
            ...
            <div className="mt-20 relative">
                  ...
                  <div className="grid grid-cols-4 gap-4">
                    {[
                      ...
                      <div key={idx} className="text-center">
                        <div
                          className={`text-3xl font-bold text-${metric.color}-600 mb-1`}
                        >
                          {metric.value}%
                        </div>
              ...
              <div className="absolute -left-6 top-2/3 hidden lg:block">
                <div
                  className="bg-white rounded-lg shadow-lg p-4 border border-slate-200 animate-float"
