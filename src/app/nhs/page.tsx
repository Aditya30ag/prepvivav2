...
export const metadata: Metadata = {
  title: 'NHS Interview Preparation | Values-Based Practice | Band 5-Consultant | PrepViva',
  description: 'Master NHS interviews from Band 5 to Consultant level. AI-powered practice aligned to NHS values, KSF dimensions, and leadership competencies with instant feedback.',
  keywords: [
    'NHS interview questions',
    'NHS values-based interview',
    'Band 5 NHS interview prep',
    'NHS competency interview',
    'NHS values practice',
    'KSF interview preparation'
  ],
}
